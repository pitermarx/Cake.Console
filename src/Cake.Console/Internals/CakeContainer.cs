...
internal sealed class CakeContainer : ICakeContainerRegistrar, Spectre.Console.Cli.ITypeRegistrar
{
        ...
        RegisterFactory(provider =>
            {
                ...
                return provider
                    .GetRequiredService<CakeConfigurationProvider>()
                    .CreateConfiguration(".", argDic);
            })
            .As<ICakeConfiguration>()
            .Singleton();
    ...
    internal class Builder(Type impl, object? instance = null) : IBuilder
    {
        private readonly Type implementationType = impl;
        private Type serviceType = impl;
        private ServiceLifetime lifetime = ServiceLifetime.Singleton;

        public IBuilder As(Type type)
        {
            serviceType = type;
            return this;
        }
        ...
        public IBuilder Singleton()
        {
            lifetime = ServiceLifetime.Singleton;
            return this;
        }

        public IBuilder Transient()
        {
        ...
        public ServiceDescriptor BuildServiceDescriptor()
        {
            ...
            {
                Func<IServiceProvider, object> factory => ServiceDescriptor.Describe(
                    serviceType,
                    factory,
                    lifetime
                ),
